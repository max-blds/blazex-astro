...
import { b as removeBase, i as isRemotePath, p as prependForwardSlash } from './path_DETEtK0P.mjs';
import { V as VALID_INPUT_FORMATS } from './_astro_assets_C5e_IU4u.mjs';
import { A as AstroError, U as UnknownContentCollectionError, a as createComponent, v as RenderUndefinedEntryError, u as unescapeHTML, d as renderTemplate, w as renderUniqueStylesheet, x as renderScriptElement, z as createHeadAndContent, r as renderComponent } from './astro/server_C4_Pur0B.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_F-9Z1JUR.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "http://conversioncollective.io/", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_C5e_IU4u.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_CULgUUse.mjs');
